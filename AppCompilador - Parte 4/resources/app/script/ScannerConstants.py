class ScannerConstants():
    ...
    TOKEN_STATE = [-2,  0, -1, -1, -2, 29, 30, 41, 39, 43, 40, 44, 42,  3,  3, 46, 45, 33, 47, 35,  0,
                   2, -1, 48,  2, 32,  5, -2, 37, 38, -1, 34, 31, 36,  0,  2,  6,  2, -2,  4,  2, -2, -2, -1,  0]

    CLASS_LEXEME = ["IDENTIFICADOR", "CONSTANTE INTEIRA", "CONSTANTE REAL",
                    "CONSTANTE STRING", "CONSTANTE CARACTERE", "PALAVRA RESERVADA",
                                        "SIMBOLO ESPECIAL"]

    SPECIAL_CASES_INDEXES = [0, 0, 0, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22,
                             22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22]

    SPECIAL_CASES_KEYS = ["and", "begin", "bool", "char", "end", "false", "float", "forward", "ifFalseDo", "ifTrueDo",
                          "int", "main", "module", "not", "or", "read", "string", "true", "void", "whileFalseDo", "whileTrueDo", "write"]

    SPECIAL_CASES_VALUES = [7, 8, 9, 10, 11, 12, 13, 14, 15,
