...
class Syntatic(Constants):
    ...
    def step(self):
        ...
        if x == self.EPSILON:
            ...
            self.semanticAnalyser.execute_action(x - self.FIRST_SEMANTIC_ACTION, self.previousToken, 0 if self.previousToken is None else self.scanner.lineToken(self.previousToken.position))
            return False